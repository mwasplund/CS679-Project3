...
function FBX_Parser_ParseProperties70(i_FileContainer)
{
  if(i_FileContainer.HasNext)
  {
    ...
    {
      Debug.Trace("FBX ERROR: Properties70 not formatted correctly");
      return null;
    }
  }
  ...
  while(i_FileContainer.HasNext)
  {
    ...
    else if(CurrentLine[0] == "P:")
    {
      ...
      {
      	Debug.Trace("FBX ERROR: Properties70: P: must be at least 5 values");
      	return null;
      }
      ...
      {
        Debug.Trace("FBX ERROR: Property Name was formated incorrectly");
        return null;
      }
      ...
      {
        Debug.Trace("FBX ERROR: Property Type was formated incorrectly");
        return null;
      }
      ...
      {
        Debug.Trace("FBX ERROR: Property More1 was formated incorrectly");
        return null;
      }
      ...
      {
        Debug.Trace("FBX ERROR: Property More2 was formated incorrectly");
        return null;
      }
    ...
    {
      Debug.Trace("FBX ERROR: Found Unknown Token in Properties70: " + CurrentLine[0]);
      return null;
    }
  }
  
  Debug.Trace("FBX ERROR: Never saw the end bracket for Properties70:");
  return null;
}
...
function FBX_Parser_ParsePropertyAsVector3D(i_Line)
{
	if(i_Line.length != 8)
	{
		Debug.Trace("FBX ERROR: The vector 3D property was formated incorrectly");
		return null;
	}
	...
	{
		Debug.Trace("FBX ERROR: The Vector 3D property was (" + X + ", " + Y + ", " + Z + ")");
		return null;
	}
