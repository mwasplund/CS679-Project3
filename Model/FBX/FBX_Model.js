...
function FBX_Parser_ParseModel(i_FileContainer)
{
 	...
 	if(i_FileContainer.HasNext)
  {
    ...
    {
      Debug.Trace("FBX ERROR: Model: not formatted correctly");
      return null;
    }
    ...
    {
    	Debug.Trace("FBX ERROR: The Model's number was NaN");
    	return null;
    }
    ...
    {
      Debug.Trace("FBX ERROR: Model Name was formatted incorrectly");
      return null;
    }
    ...
    {
    	Debug.Trace("FBX ERROR: Model Type was formatted incorrectly");
      return null;
    }
  }
  ...
  while(i_FileContainer.HasNext)
  {
    ...
    else if(CurrentLine[0] == "Version:")
    {
      ...
      {
      	Debug.Trace("FBX ERROR: The Model's Version was NaN");
      	return null;
      }
    }
		else if(CurrentLine[0] == "MultiLayer:")
    {
      ...
      {
      	Debug.Trace("FBX ERROR: The Model's MultiLayer was NaN");
      	return null;
      }
    }
		else if(CurrentLine[0] == "MultiTake:")
    {
      ...
      {
      	Debug.Trace("FBX ERROR: The Model's MultiTake was NaN");
      	return null;
      }
    }
		...
		else if(CurrentLine[0] == "Culling:")
    {
      ...
      {
      	Debug.Trace("FBX ERROR: Model Culling was formatted incorrectly");
        return null;
      }
    }
    else
    {
      Debug.Trace("FBX ERROR: Found Unknown Token in Model: " + CurrentLine[0]);
      return null;
    }
  }
  
  Debug.Trace("FBX ERROR: Never saw the end bracket for Model:");
  return null;
}
