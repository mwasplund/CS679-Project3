...
function FBX_Parser_ParseTexture(i_FileContainer)
{
 	...
 	if(i_FileContainer.HasNext)
  {
    ...
    {
      Debug.Trace("FBX ERROR: Texture not formatted correctly");
      return null;
    }
    ...
    {
    	Debug.Trace("FBX ERROR: The Texture's number was NaN");
    	return null;
    }
    ...
    {
      Debug.Trace("FBX ERROR: Texture Name was formatted incorrectly");
      return null;
    }
    ...
    {
    	Debug.Trace("FBX ERROR: Texture Type was formatted incorrectly");
      return null;
    }
  }
  ...
  while(i_FileContainer.HasNext)
  {
		...
		else if(CurrentLine[0] == "Version:")
    {
      ...
      {
      	Debug.Trace("FBX ERROR: The Texture's Version was NaN");
      	return null;
      }
    }
    else if(CurrentLine[0] == "TextureName:")
    {
      ...
      {
      	Debug.Trace("FBX ERROR: Texture TextureName was formatted incorrectly");
        return null;
      }
    }
    else if(CurrentLine[0] == "Media:")
    {
      ...
      {
      	Debug.Trace("FBX ERROR: Texture Media was formatted incorrectly");
        return null;
      }
    }
    else if(CurrentLine[0] == "FileName:")
    {
      ...
      {
      	Debug.Trace("FBX ERROR: Texture FileName was formatted incorrectly");
        return null;
      }
    }
		else if(CurrentLine[0] == "RelativeFilename:")
    {
      ...
      {
      	Debug.Trace("FBX ERROR: Texture RelativeFilename was formatted incorrectly");
        return null;
      }
    }
