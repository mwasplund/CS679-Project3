...
function FBX_Parser_ParseConnections(i_FileContainer)
{
 	...
 	if(i_FileContainer.HasNext)
  {
    ...
    if(FirstLine.length != 2 || FirstLine[0] != "Connections:" || FirstLine[1] != "{")
      throw "FBX ERROR: Connections: not formatted correctly";
  }
  ...
  while(i_FileContainer.HasNext)
  {
    ...
    {
      Debug.Trace("FBX ERROR: Found Unknown Token in Connections: " + CurrentLine[0]);
      return null;
    }
  }
  
  Debug.Trace("FBX ERROR: Never saw the end bracket for Connections:");
  return null;
}
