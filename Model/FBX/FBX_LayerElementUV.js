...
function FBX_Parser_ParseLayerElementUV(i_FileContainer)
{
  ...
  if(i_FileContainer.HasNext)
  {
    ...
    {
      Debug.Trace("FBX ERROR: LayerElementUV: not formatted correctly");
      return null;
    }
    ...
    {
      Debug.Trace("FBX ERROR: The LayerElementUV: number was NaN");
      return null;
    }
  }
  ...
  while(i_FileContainer.HasNext)
  {
		...
		else if(CurrentLine[0] == "Version:")
    {
      ...
      {
      	Debug.Trace("FBX ERROR: The LayerElementUV's Version was NaN");
      	return null;
      }
    }
    else if(CurrentLine[0] == "Name:")
    {
      ...
      {
      	Debug.Trace("FBX ERROR: LayerElementUV Name was formatted incorrectly");
        return null;
      }
    }
    else if(CurrentLine[0] == "MappingInformationType:")
    {
      ...
      {
      	Debug.Trace("FBX ERROR: LayerElementUV MappingInformationType was formatted incorrectly");
        return null;
      }
    }
    else if(CurrentLine[0] == "ReferenceInformationType:")
    {
      ...
      {
      	Debug.Trace("FBX ERROR: LayerElementUV ReferenceInformationType was formatted incorrectly");
        return null;
      }
    }
    ...
    {
      Debug.Trace("FBX ERROR: Found Unknown Token in LayerElementUV: " + CurrentLine[0]);
      return null;
    }
  }
  
  Debug.Trace("FBX ERROR: Never saw the end bracket for LayerElementUV:");
  return null;
}
...
function  FBX_Parser_ParseUVIndex(i_FileContainer)
{
  ...
  if(i_FileContainer.HasNext)
  {
    ...
    {
      Debug.Trace("FBX ERROR: UVIndex: not formatted correctly");
      return null;
    }
    ...
    if(isNaN(Count))
    {
      Debug.Trace("FBX ERROR: The UVIndex: count was NaN");
      return null;
    }
  }
  ...
  if(i_FileContainer.HasNext)
  {
    ...
    for(var i = 1; i < SecondLine.length; i++)
    {
      ...
      if(isNaN(Value))
      {
        Debug.Trace("FBX ERROR: A UVIndex was " + Value);
        return null;
      }
      UVIndex.push(Value);
    }
  ...
  while(i_FileContainer.HasNext)
  {
    ...
    if(CurrentLine[0] == "}")
    {
    	...
    	{
    		Debug.Trace("FBX ERROR: Expected " + Count + " UVIndex's but found " + UVIndex.length);
    		return null;
    	}
    	else
    	{
   ...
   Debug.Trace("FBX ERROR: Never saw the end bracket for UV:");
   return null;
}
...
function  FBX_Parser_ParseUV(i_FileContainer)
{
  ...
  if(i_FileContainer.HasNext)
  {
    ...
    {
      Debug.Trace("FBX ERROR: UV: not formatted correctly");
      return null;
    }
    ...
    if(isNaN(Count))
    {
      Debug.Trace("FBX ERROR: The UV: count was NaN");
      return null;
    }
    if((Count % 2) != 0)
    {
      // There was an invalid number of numbers
      Debug.Trace("FBX ERROR: The UV: count was not a multiple of two.");
      return null;
    }
  ...
  if(i_FileContainer.HasNext)
  {
    ...
    for(var i = 1; i < SecondLine.length; i++)
    {
      ...
      if(isNaN(Value))
      {
        Debug.Trace("FBX ERROR: A UV was " + Value);
        return null;
      }
      UV.push(Value);
    }
  ...
  while(i_FileContainer.HasNext)
  {
    ...
    if(CurrentLine[0] == "}")
    {
    	if(UV.length != Count)
    	{
    		Debug.Trace("FBX ERROR: Expected " + Count + " UV's but found " + UV.length);
    		return null;
    	}
    	else
    	{
