...
function InitializeModels() 
{
  ...
  Loader.load("Link", Path + );
  Loader.load("TestCube", Path + );
  Loader.load("fbxTest", Path + );
  Loader.load("handFbx", Path + );
  Loader.load("WolfSpider_Linked", Path + );
  Loader.load("GyroStaff", Path + );
...
{
	var Path = "../../Shader/";
  Shaders.push(LoadShader("PerFragmentLighting", Path+"PerFragmentLighting.vs", Path+"PerFragmentLighting.fs"));
  Shaders.push(LoadShader("PerVertexLighting", Path+"PerVertexLighting.vs", Path+"PerVertexLighting.fs"));
  Shaders.push(LoadShader("TimeTest", Path+"TimeTest.vs", Path+"TimeTest.fs"));
